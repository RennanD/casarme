    ...
    <section id="home" className="relative min-h-screen flex items-center justify-center overflow-hidden bg-[#FFF8F0]">
      ...
      <div className="relative z-10 container mx-auto px-4 py-20">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          {/* Image Content */}
          <div className="flex justify-center rounded-lg lg:justify-end animate-fade-in [animation-delay:200ms]">
            <div className="relative rounded-lg overflow-hidden">
              {/* Mockup dos celulares */}
              <Image src="/mockups.webp" alt="Mockup" width={700} height={700} />
            </div>
          </div>
        </div>
      </div>
